      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="hidden md:block">
          <div className="flex items-center gap-8 md:gap-12">
            <h2 className="text-primary text-center font-semibold text-sm md:text-[0.75rem] whitespace-nowrap">
              REGISTERED & CERTIFIED:
            </h2>
            <div className="flex-1 grid grid-cols-6 gap-4 md:gap-8">
              {certifications.map((cert) => (
                <div key={cert.title} className="text-center">
                  <p className="text-primary font-[auto] font-bold text-xs md:text-sm mb-1">
                    {cert.title}
                  </p>
