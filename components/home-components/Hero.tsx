      ...
      <div className="relative z-10 w-full px-4 py-12 md:py-0">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 md:mb-16">
            <Link href={URLS.CONTACT} className="bg-secondary hover:bg-secondary-hover text-primary font-semibold px-8 py-3 md:px-10 md:py-4 transition-colors flex items-center gap-2">
              Submit RFQ
            ...
            <Link href={'/'} className="border-2 border-gray-300 hover:border-white text-white hover:bg-white/10 font-semibold px-8 py-3 md:px-10 md:py-4 transition-colors flex items-center gap-2">
