...
const quickFacts = [
  {
    label: "MOQ",
    value: "100 sq. meters or 50 standard pieces",
  },
  {
    label: "Lead Time",
    value: "60-90 days for hand-knotted",
  },
  {
...
const specifications = [
  {
    label: "Types",
    value: "Hand-knotted, Hand-tufted, Flatweave, Machine-made",
  },
  {
    label: "Materials",
    value: "Pure wool, Silk, Wool-silk blend, Viscose, Cotton",
  },
  {
    label: "Pile Height",
    value: "Low (3-6mm), Medium (6-12mm), High (12mm+)",
  },
  {
    label: "Knot Density",
    value: "100-400 KPSI (hand-knotted)",
  },
  {
    label: "Size Availability",
    value: "Custom sizes available up to 12x15 ft standard",
  },
];
...
const tradeDetails = [
  ...
  {
    label: "Packaging",
    value: "Roll-packed, water-resistant wrapping, labeled for customs",
  },
  {
    label: "Lead Time",
    value: "60-90 days for hand-knotted | 30-45 days for machine-made",
  },
  {
    label: "Certifications",
    value: "CEPC, Woolmark, IEC, GST",
  },
];
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-10">
        ...
        <div className="flex flex-col justify-start">
          ...
          <p className="mt-5 max-w-xl text-base leading-relaxed text-slate-600">
            Premium hand-knotted and machine-made carpets from established
            weaving centers in Kashmir, Bhadohi, and Agra. Our carpets meet
            international quality and safety standards, including US and EU
            compliance.
          </p>
